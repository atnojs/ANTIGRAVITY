...
**🌍 Idioma Oficial**: Todo archivo `SKILL.md` y su documentación asociada deben redactarse obligatoriamente en **español**, siguiendo la directiva de la habilidad `reglas_globales`.
