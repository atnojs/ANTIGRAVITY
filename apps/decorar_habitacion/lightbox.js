...
(function () {
  ...
  if (!document.getElementById('lightbox-antigravity')) {
    ...
    lightbox.style.cssText = 'position:fixed;inset:0;background:rgba(0,0,0,0.9);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);z-index:90000;display:none;align-items:center;justify-content:center;cursor:zoom-out;';
    lightbox.innerHTML = `
