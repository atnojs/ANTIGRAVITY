    ...
    return (
      <div className="min-h-screen relative">
        ...
        <main className="max-w-6xl mx-auto px-4 py-8 text-center">
          <h1 className="app-title">DECORADOR DE ESPACIOS</h1>
          <h2 className="app-hero-title">Elige el espacio que quieres decorar</h2>
    ...
    <div className="min-h-screen relative">
      ...
      <header className="sticky top-0 z-10 py-3">
        <div className="max-w-6xl mx-auto px-4 flex items-center justify-between relative">
          <button className="px-4 py-2 rounded-lg bg-gray-900 text-white disabled:opacity-50 btn-3d text-sm" onClick={resetAll} disabled={busy} type="button">
            ← Cambiar estancia
          </button>
