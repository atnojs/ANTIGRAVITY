...
const getEffectsDescription = (settings, aiAction = "", currentAR = "", originalAR = "") => {
    const effects = [];

    // Si hay una acción de IA, la ponemos primero
    if (aiAction) {
        effects.push(`IA: ${aiAction}`);
    }

    // Si el AR cambió respecto al original, mostrarlo
    if (currentAR && originalAR && currentAR !== originalAR) {
        effects.push(`AR: ${originalAR} → ${currentAR}`);
    }
...
const STYLE_PRESETS = [
    {
        ...
        prompt: 'Convierte esta imagen en un mundo LEGO completamente reconstruido. Dirección artística obligatoria: Reinterpreta absolutamente todos los elementos (personajes, objetos, entorno) como piezas LEGO reales, claramente identificables. Uso visible de bloques, studs, placas y piezas LEGO oficiales, sin formas orgánicas realistas. Personajes tipo minifigura LEGO, con cabeza cilíndrica, extremidades cilíndricas, manos en forma de gancho y proporciones rígidas. Materiales y acabado: Aspecto de juguete de plástico, con superficies brillantes, reflejos limpios y colores sólidos. Texturas lisas con ligeras imperfecciones de moldeado (líneas de unión, brillo plástico). Nada de texturas realistas (piel, tela, madera real, etc.). Escena y composición: Mantén la composición, encuadre y distribución de la imagen original. El entorno (suelo, paredes, cielo, objetos) debe estar construido con piezas LEGO, no pintado ni ilustrado. Reglas: No apliques filtros ni estilos pictóricos. Evita look de juguete genérico o 3D realista. El resultado debe parecer un fotograma de una película LEGO oficial, coherente, divertido y completamente hecho de bloques LEGO.'
    },
    {
        id: 'comic-americano',
        label: 'Cómic Americano · Marvel / DC',
        prompt: 'Transforma esta imagen en una viñeta de cómic americano clásico estilo Marvel/DC. Dirección artística obligatoria: Contornos de líneas negras gruesas y limpias, con variación de grosor para dar dinamismo. Personajes con musculatura definida y anatomía heroica, poses potentes y expresivas. Colores vivos y contrastados, claramente separados por áreas. Sombreado y textura: Sombras marcadas y dramáticas, priorizando el volumen. Uso visible de patrones halftone (puntos) para sombras y degradados. Evita degradados suaves o realistas; el sombreado debe ser gráfico. Composición de cómic: Lectura clara tipo viñeta, con énfasis en acción y narrativa visual. Siluetas fuertes y fondos simplificados cuando sea necesario para destacar al personaje. Referencias claras: Estilo Marvel/DC clásico y moderno (cómic impreso, no digital). Reglas: Reinterpreta la imagen como ilustración de cómic, no como foto retocada. Mantén la composición y elementos clave de la escena original. El resultado debe parecer una viñeta profesional lista para publicación, no un filtro de color aplicado sobre una foto.'
    },
    {
        id: 'pixar',
        label: 'Pixar · 3D CGI expresivo',
        prompt: 'Reinterpreta esta imagen como una escena 3D CGI de alto nivel al estilo Pixar, como si fuera un fotograma extraído de una película. Dirección artística obligatoria: Personajes caricaturizados pero creíbles, con proporciones suaves y equilibradas. Rostros muy expresivos, ojos grandes y vivos, emociones claras y naturales. Rasgos redondeados, amigables y coherentes con el lenguaje visual Pixar. Iluminación y render: Iluminación global (GI) realista y detallada, con rebotes de luz suaves. Iluminación cinematográfica que refuerce el tono emocional de la escena. Sombras limpias, suaves y bien integradas. Materiales y superficies: Materiales con textura suave y creíble (piel, tela, plástico, metal, madera, etc.). Evita superficies planas o plásticas sin detalle. Microdetalles sutiles que aporten realismo sin perder estilo cartoon. Escena y fondo: Fondos coherentes y bien integrados, con profundidad y escala. Separación clara entre personajes y entorno mediante luz y color. Reglas: Mantén la composición, encuadre y elementos clave de la imagen original. Evita estilos hiperrealistas, anime, low-poly o 3D genérico. El resultado debe parecer un frame oficial de una película de Pixar, pulido, emotivo y profesional, no una ilustración 3D con filtro “Pixar”.'
    },
    {
        id: 'disney-clasico',
        label: 'Disney Clásico · 2D vibrante',
        prompt: 'Convierte esta imagen en animación 2D clásica al estilo Disney tradicional. Dirección artística obligatoria: Líneas fluidas, limpias y expresivas, con variación natural de grosor (line art dibujado a mano). Personajes con proporciones idealizadas y armoniosas, expresivos y llenos de vida. Gestos claros, poses naturales y siluetas bien definidas. Color y sombreado: Colores vibrantes pero naturales, equilibrados y coherentes con la escena. Sombreado suave pintado a mano, sin degradados digitales duros ni cel-shading moderno. Volúmenes bien definidos mediante luz y color, no por realismo extremo. Estética y acabado: Sensación de animación tradicional sobre acetato. Texturas sutiles que recuerden al dibujo y la pintura manual. Ambiente cálido, mágico y atemporal. Referencias claras: Blancanieves y los siete enanitos. El Rey León Animación Disney clásica (años 30–90). Reglas: Mantén la composición y los elementos clave de la imagen original. Evita estilos modernos, anime, 3D o caricatura simplificada. El resultado debe parecer un fotograma auténtico de una película Disney clásica, no una imagen moderna con filtro “Disney”.'
    },
    {
        id: 'cartoon-network',
        label: 'Cartoon Network · Cartoon moderno',
        prompt: 'Recrea esta escena con estética Cartoon Network moderna, como si fuera un fotograma de una serie animada actual. Dirección artística obligatoria: Personajes simples y altamente estilizados, con formas geométricas claras (redondeadas o angulares). Proporciones caricaturescas, expresiones exageradas y lectura visual inmediata. Paletas de color planas, limpias y llamativas, sin degradados realistas. Diseño visual: Fondos simplificados, con pocos elementos pero bien definidos. Separación clara entre personajes y fondo mediante color y contraste. Líneas limpias, contornos definidos y diseño gráfico fuerte. Referencias claras: Hora de Aventura Steven Universe. The Amazing World of Gumball (partes animadas). Reglas: Mantén la composición y la escena original, reinterpretadas fielmente en este estilo. Evita realismo, texturas fotográficas o sombreado complejo. El resultado debe parecer un frame real de una serie de Cartoon Network, listo para animarse, no una ilustración infantil genérica ni una foto cartoonizada.'
    },
    {
        id: 'tim-burton',
        label: 'Tim Burton · Gótico / Stop-motion',
        prompt: 'Transforma esta imagen al estilo stop-motion gótico inspirado en Tim Burton. Dirección artística obligatoria: Paleta oscura y desaturada, con predominio de negros, grises, azules fríos y tonos apagados. Personajes muy delgados y alargados, extremidades finas, proporciones estilizadas y ligeramente antinaturales. Ojos grandes y muy expresivos, con mirada melancólica o soñadora. Siluetas marcadas y diseño gráfico fuerte. Estética y atmósfera: Contrastes de luz intensos (claroscuro), iluminación dramática y direccional. Ambientes sombríos, poéticos y caprichosos, con sensación de cuento oscuro. Texturas físicas sutiles que recuerden al stop-motion artesanal, no a 3D digital pulido. Referencias claras: Pesadilla antes de Navidad La novia cadáver Cine stop-motion gótico clásico de Tim Burton Reglas: Mantén la composición y la escena original, reinterpretadas fielmente en este estilo. Evita colores vivos, realismo fotográfico o estilos modernos. El resultado debe parecer un fotograma auténtico de una película stop-motion gótica, melancólica y artística, no una imagen con filtro “Burton”.'
    },
    {
        id: 'claymation',
        label: 'Claymation · Plastilina',
        prompt: 'Reinterpreta esta escena como claymation auténtico (stop-motion de plastilina). Características obligatorias del estilo: Todo debe parecer modelado a mano en plastilina o arcilla, con huellas, imperfecciones y marcas físicas visibles. Personajes y objetos con volúmenes redondeados, proporciones ligeramente caricaturescas. Superficies mates, con textura orgánica, sin suavizados digitales ni apariencia plástica artificial. Detalles como uniones, pliegues y pequeñas irregularidades propias del modelado manual. Referencias claras: Estética tipo Wallace & Gromit, Aardman Animations, stop-motion clásico. Iluminación y escena: Iluminación de set físico, con sombras suaves y coherentes, como un escenario real de stop-motion. Profundidad y escala creíbles, evitando look 3D digital moderno. Reglas: Mantén la composición y elementos esenciales de la imagen original. No apliques filtros, desenfoques ni efectos automáticos. El resultado debe parecer un fotograma real de una animación en plastilina, no una foto con efecto clay.'
    },
    {
        id: 'pop-art',
        label: 'Pop Art · Colores planos pop',
        prompt: 'Convierte esta imagen en una ilustración Pop Art clásica con estética de póster. Características obligatorias del estilo: Colores planos, muy brillantes y contrastados, sin degradados realistas. Contornos negros marcados y limpios, claramente visibles. Uso evidente de puntos Ben-Day para sombras y volúmenes. Simplificación gráfica de formas, con alto impacto visual. Referencias artísticas claras: Roy Lichtenstein (cómic pop, Ben-Day, dramatismo gráfico). Andy Warhol (paletas atrevidas, sensación de póster icónico). Reglas: Reinterpreta la imagen como ilustración, no como fotografía retocada. Mantén la composición y el sujeto reconocibles, pero totalmente transformados al lenguaje Pop Art. Evita realismo, texturas fotográficas o efectos de saturación modernos. El resultado debe parecer un póster Pop Art serigrafiado, llamativo y artístico, listo para exposición o impresión.'
    },
    {
        id: 'fotorrealista-digital',
        label: 'Fotorrealista · Pintura digital',
        prompt: 'Transforma esta imagen en una pintura digital fotorrealista de alta calidad. Re-renderizado obligatorio: Vuelve a pintar toda la escena desde cero usando pincel digital, no filtros automáticos. Mantén máximo nivel de detalle en luz, sombra, volúmenes y texturas (piel, telas, materiales, superficies). Pinceladas sutiles y controladas, perceptibles solo al observar de cerca. Realismo avanzado: Iluminación físicamente coherente y sombras naturales. Texturas ricas y creíbles, sin aspecto plástico ni “airbrush”. Colores precisos, profundidad tonal y microcontraste realista. Reglas: Conserva composición, encuadre y proporciones de la imagen original. Evita estilización evidente o trazos expresivos exagerados. El resultado debe parecer una ilustración pintada a mano, pero indistinguible de una fotografía real a primera vista.'
    },
    {
        id: 'fotorrealista-cine',
        label: 'Fotorrealista · Cinemático',
        prompt: 'Reinterpreta esta imagen como un fotograma cinematográfico de alto presupuesto. Estética cinematográfica: Contraste suave y controlado, con negros profundos pero con detalle. Gradación de color tipo cine (color grading profesional), coherente y narrativa. Profundidad de campo controlada, separando sujeto y fondo de forma natural. Iluminación dramática y direccional, con intención cinematográfica (key, fill, rim si procede). Realismo y acabado: Mantén un realismo creíble, sin exageraciones ni looks artificiales. Texturas naturales de piel, materiales y entorno. Evita sobreenfoque, HDR agresivo o efectos digitales evidentes. Referencias implícitas: Sensación de cine de gran formato (look “película ancha”), calidad de producción alta. El resultado debe parecer un frame extraído de una película profesional, no una foto con filtro cinematográfico.'
    },
    {
        id: 'concept-art',
        label: 'Arte Conceptual · Concept Art',
        prompt: 'Convierte esta escena en concept art cinematográfico. Dirección artística: Pintura digital suelta, con pinceladas visibles y bordes no perfectamente definidos. Prioriza el mood, la atmósfera y la lectura general de la escena por encima del detalle fino. Iluminación expresiva y direccional; añade niebla, bruma o partículas si refuerzan la narrativa visual. Paleta de color coherente con la emoción de la escena (fría, cálida, dramática, melancólica, épica, etc.). Enfoque de concept art: Diseño claro de formas grandes y medianas (big shapes first). Profundidad atmosférica mediante luz, color y contraste. Sensación de mundo y escala, aunque algunos elementos queden sugeridos. Reglas: Mantén la composición y elementos clave de la imagen original. Evita hiperrealismo, exceso de nitidez o acabado fotográfico. El resultado debe parecer un concept oficial de videojuego o película, usado para definir tono y diseño, no una ilustración final pulida.'
    },
    {
        id: 'pixel-art',
        label: 'Pixel Art / 8-bit · Retro',
        prompt: 'Recrea esta imagen como pixel art de baja resolución auténtico. Reglas obligatorias del estilo: Reduce la escena a pocos píxeles grandes y claramente visibles. Usa una paleta de colores muy limitada, coherente con estética 8-bit o 16-bit. Cada elemento debe construirse únicamente con píxeles cuadrados definidos. Prohibido desenfoque, suavizado, degradados suaves o efectos modernos. Dirección artística: Siluetas simples pero reconocibles. Contraste claro entre luces y sombras mediante bloques de color. Estética de videojuego retro clásico (arcade, NES, SNES, Mega Drive). Mantén la composición y los elementos esenciales de la imagen original, reinterpretados fielmente en pixel art. El resultado debe parecer un sprite o una escena extraída directamente de un videojuego retro, no una imagen moderna pixelada artificialmente.'
    },
    {
        id: 'rubber-hose',
        label: 'Rubber Hose · Años 30 / Cuphead',
        prompt: 'Transforma completamente esta escena al estilo de animación Rubber Hose clásico de los años 30. Características obligatorias del estilo: Personajes cartoon con extremidades tipo manguera de goma, sin articulaciones visibles. Ojos grandes y simples, expresivos, con diseño retro (tipo “pie-cut eyes”). Posturas exageradas y sensación de movimiento rebotante, como si fuera un fotograma congelado de una animación. Proporciones caricaturescas, gestos muy expresivos y siluetas claras. Estética vintage: paleta limitada, ligero grano de película, contraste suave, líneas limpias y acabados planos. Referencias visuales claras: Cuphead, primeros cortos de Disney y animación Rubber Hose original (años 1920–1930). Reglas: Mantén la composición y la escena original, reinterpretadas fielmente en este estilo. No introduzcas rasgos modernos, realistas ni estilos posteriores. El resultado debe parecer un frame auténtico de un corto animado clásico, no una ilustración moderna con filtro retro.'
    }
];
...
const App = () => {
    ...
    const [originalImageAR, setOriginalImageAR] = useState("9:16"); // AR original de la imagen subida
    const [appliedAiAction, setAppliedAiAction] = useState("");
    ...
    const handleImageUpload = (e) => {
        ...
        reader.onload = (event) => {
            const img = new Image();
            img.onload = () => {
                // --- NUEVA LÓGICA DE DETECCIÓN DE AR ---
                ...
                // Buscamos cuál de nuestros botones es el más parecido a la imagen real
                let closestAR = "1:1";
                let minDifference = Math.abs(imgRatio - 1);

                for (const [label, value] of Object.entries(availableRatios)) {
                    const difference = Math.abs(imgRatio - value);
                ...
                // Actualizamos el estado para que el botón azul cambie solo
                setSelectedAR(closestAR);
                setOriginalImageAR(closestAR); // Guardar AR original de la imagen
                // ---------------------------------------
    ...
    const saveToHistory = () => {
        ...
        // Generar descripción de efectos aplicados (incluyendo AR si cambió)
        const effectsDescription = getEffectsDescription(currentSettings, appliedAiAction, selectedAR, originalImageAR);
        ...
        const newHistoryItem = {
            ...
            appliedAR: selectedAR // Guardar el AR aplicado
        };
        ...
        // Restaurar el AR original de la imagen base
        setSelectedAR(originalImageAR);

        // Resetear la acción de IA aplicada
        setAppliedAiAction("");
    ...
    const handleAiEnhance = () => {
        executeWithLimit(() => callGeminiAPI(
            "image",
            "Actúa como un editor fotográfico profesional. Mejora sutilmente esta imagen: equilibra la exposición, corrige el balance de blancos, reduce el ruido digital y mejora la nitidez. Mantén el realismo."
        ));
    };
    ...
    const handleAiStyle = (styleText) => {
        // Buscamos el nombre del estilo para guardarlo
        const styleObj = STYLE_PRESETS.find(s => s.prompt === styleText);
        setAppliedAiAction(styleObj ? styleObj.label : "Estilo Personalizado");
        const stylePrompt = `
Eres un motor de EDICIÓN DE ESTILO de imagen a imagen muy avanzado.
Aplica el siguiente estilo visual a esta imagen de forma estricta. 
DIRECCIÓN TÉCNICA OBLIGATORIA, REGLAS DE FIDELIDAD INNEGOCIABLES:
- NO muevas a los personajes ni cambies su posición.
- MANTÉN las dimensiones, el encuadre y el formato original. NO RECORRTES la imagen.NO cambies la composición ni los elementos del fondo.
- MANTÉN a las personas y objetos en su posición exacta. NO los muevas ni cambies su pose.MANTÉN la identidad de las personas y objetos intacta.
- SOLO transforma la textura, materiales, tipos de líneas, sombreado, el acabado artístico y la paleta de colores según esta descripción: ${styleText}
- El resultado debe ser una versión estilizada de la IMAGEN ORIGINAL, no una recreación nueva.
        `;
...
{"top": "TEXTO SUPERIOR CORTO", "bottom": "TEXTO INFERIOR CORTO"}
    ...
    const callGeminiAPI = async (mode, promptText, options = {}) => {
        ...
        try {
            ...
            const aspectRatio = options.aspectRatio || selectedAR;
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-6">
                        ...
                        <div className="p-4 bg-gradient-to-br from-indigo-900/50 to-slate-900 rounded-xl border border-indigo-500/40 shadow-lg relative overflow-hidden">
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    <option value="">Selecciona un Estilo y Aplícalo</option>
                            ...
                            {/* === SECCIÓN COMPLETA: ACCIONES RÁPIDAS + AR INTEGRADO === */}
                            <div className="space-y-4">




                                {/* GRILLA DE BOTONES DE ACCIÓN OPTIMIZADA */}
                                <div className="grid grid-cols-2 gap-2">
                                    {[
                                        { id: "Auto-Mejora", label: "Auto-Mejora", icon: "image-plus", func: handleAiEnhance, desc: "Mejora automática: exposición, balance de blancos y nitidez manteniendo la estructura original." },
                                        { id: "Social Post", label: "Social Post", icon: "share-2", func: handleAiSocial, desc: "Genera automáticamente un título para redes sociale y 5 hashtags relevantes sin alterar la imagen." },
                                        { id: "Paleta Color", label: "Paleta Color", icon: "palette", func: handleAiPalette, desc: "Extrae los 5 colores dominantes de la imagen en formato de códigos HEX." },
                                        { id: "Crear Meme", label: "Crear Meme", icon: "smile", func: handleAiMeme, desc: "Genera un texto divertido para la parte superior e inferior de tu imagen respetando el AR original." },
                                        { id: "Enfoque Selectivo", label: "Enfoque Selectivo", icon: "aperture", func: handleAiFocalBlur, desc: "Desenfoca el fondo de forma artística para resaltar al sujeto principal sin mover al sujeto." },
                                        { id: "Campo Profundo", label: "Campo Profundo", icon: "camera", func: handleAiDepthOfField, desc: "Simula un efecto de cámara profesional DSLR con un bokeh suave sin alterar la composición." },
                                        { id: "Retoque Piel", label: "Retoque Piel", icon: "user", func: handleAiSkinRetouch, desc: "Suaviza la piel y elimina imperfecciones de forma natural y sutil respetando rasgos y posiciones." },
                                        { id: "Mejora Baja Luz", label: "Mejora Baja Luz", icon: "moon", func: handleAiLowLightEnhancement, desc: "Mejora fotos oscuras reduciendo el ruido y recuperando detalle en sombras sin cambiar el encuadre." },
                                        { id: "Corrección Color", label: "Corrección Color", icon: "droplet", func: handleAiColorCorrection, desc: "Corrige el balance de blancos y la colorimetría para un look natural." },
                                        { id: "Corrección Lente", label: "Corrección Lente", icon: "maximize", func: handleAiLensCorrection, desc: "Endereza líneas curvas y corrige la perspectiva de la toma original respetando el AR detectado." },
                                        { id: "Modo Retrato", label: "Modo Retrato", icon: "user-check", func: handleAiPortraitMode, desc: "Optimiza la iluminación facial y aplica un acabado de estudio profesional." }
                                    ].map((btn) => (
                                        <button
                                            key={btn.id}
                                            onClick={() => {
                                                // Forzamos que se use el AR seleccionado en todas las funciones
                                                btn.func();
                                            }}
                                            disabled={!originalImage || isProcessing}
                                            onMouseEnter={() => setHoveredButton({ label: btn.label, description: btn.desc })}
                                            onMouseLeave={() => setHoveredButton(null)}
                                            className={`py-1.5 text-[10px] rounded border transition-all duration-200 flex justify-center items-center gap-1 ${hoveredButton?.label === btn.label
                                ...
                                {/* SECCIÓN AR / ESPACIO DE LEYENDA (RECTÁNGULO ROJO) */}
                                <div className="relative min-h-[90px] p-3 rounded-xl bg-slate-800/40 border border-slate-700/50 overflow-hidden">

                                    {/* VISTA NORMAL: BOTONES AR */}
                                    <div className={`transition-opacity duration-300 ${hoveredButton ? 'opacity-0' : 'opacity-100'}`}>
                                        <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-2 block">
                                            Expansión creativa (AR)
                                        </label>
                                        <div className="grid grid-cols-4 gap-1">
                                            {["1:1", "9:16", "16:9", "4:3", "21:9", "2:3", "3:2"].map((ratio) => (
                                                <button
                                                    key={ratio}
                                                    onClick={() => { handleAiExpand(ratio); setSelectedAR(ratio); }}
                                                    disabled={!originalImage || isProcessing}
                                                    className={`py-1 text-[9px] rounded border transition-all duration-200 font-bold ${selectedAR === ratio
                                    ...
                                    {/* VISTA HOVER: LEYENDA ESTILO SLIDER (Ocupa el mismo espacio) */}
                                    {hoveredButton && (
                                        <div className="absolute inset-0 p-3 flex flex-col justify-center bg-slate-900/90 backdrop-blur-sm animate-in fade-in zoom-in-95 duration-200">
