...
const FIREBASE_CONFIG = {
  apiKey: "AIzaSyBwlhkjEtr4WuRyt7HMbo4NiVExtemKh6w",
  authDomain: "edicion-de-imagenes-f7d0a.firebaseapp.com",
  projectId: "edicion-de-imagenes-f7d0a",
  storageBucket: "edicion-de-imagenes-f7d0a.firebasestorage.app",
  messagingSenderId: "453493796414",
  appId: "1:453493796414:web:635d7c0ac1c2ccc62cab6f",
  measurementId: "G-HYF9HN12E6"
};
            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                <section className="flex-1 canvas-container flex items-center justify-center relative overflow-hidden bg-slate-950">
                    ...
                    <canvas
                        ...
                        className={`max-w-full max-h-full object-contain shadow-2xl ring-1 ring-white/10 transition-opacity duration-300 ${
                            !originalImage ? 'opacity-0 absolute' : 'opacity-100'
