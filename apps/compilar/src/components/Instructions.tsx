      ...
      <div className="border border-neutral-200 dark:border-neutral-800 rounded-xl bg-white dark:bg-neutral-900 overflow-hidden shadow-sm">
        ...
        <div className="p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-6">
          ...
          <div className="space-y-1">
            ...
            <div className="font-semibold text-neutral-800 dark:text-neutral-200 font-mono text-[11px] bg-neutral-100 dark:bg-neutral-800 py-0.5 px-2 rounded w-fit">
          ...
          <div className="space-y-1 col-span-1 sm:col-span-2">
            ...
            <div className="flex flex-wrap gap-1.5 pt-1">
              <span className="inline-flex items-center gap-1 text-[11px] px-2 py-0.5 bg-neutral-100 dark:bg-neutral-800 rounded text-neutral-700 dark:text-neutral-400 font-mono">
      ...
      <div className="space-y-4">
          ...
          <>
            ...
            <div className="flex gap-3">
              ...
              <div className="space-y-1 flex-1">
                ...
                <div className="mt-1.5 p-2 rounded bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-800/60 font-mono text-[10px] flex items-center gap-1.5">
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-1 flex-1">
            ...
            {deployment?.deployType === "subfolder" && (
              <div className="bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-500/10 p-2 rounded mt-1.5 flex items-start gap-1.5">
