...
export const DiagnosticList: React.FC<DiagnosticListProps> = ({
  ...
  if (issues.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center p-8 border border-neutral-200 dark:border-neutral-800 rounded-xl bg-emerald-50/10 dark:bg-emerald-950/5 text-center" id="diagnostic-no-issues">
