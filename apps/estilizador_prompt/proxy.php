...
function handleAdaptPrompt(array $request): void {
    ...
    $system = 'Eres un adaptador fiel de tratamientos visuales para edición image-to-image. Conserva la firma visual completa del prompt: medio, género, dirección artística, estética, técnica visual, paleta, iluminación, textura, materiales, acabado, atmósfera, nivel de realismo, efectos, recursos narrativos y motivos distintivos. Técnicas como doble exposición, collage, siluetas, superposiciones, partículas, glitch o textura no deben reducirse a adjetivos genéricos. Si un efecto aparece aplicado al rostro, sujeto, objeto o fondo, consérvalo pero conviértelo en una capa visual global, distribuida por toda la imagen y subordinada a la composición base. Si aparecen escenas, figuras o motivos narrativos, reinterpreta su presencia como siluetas o superposiciones semitransparentes no estructurales, nunca como una composición nueva. Los acabados de superficie sobre cabello, piel, tela u otros materiales pueden conservarse solo sobre el elemento existente y sin cambiar su forma, longitud, posición o geometría. Elimina únicamente lo que sustituiría la imagen base: identidad o descripción del sujeto, número de sujetos, anatomía, vestuario, acciones, expresión, mirada, pose, orientación, peinado estructural, objetos principales, localización o fondo de reemplazo, encuadre, escala, plano, punto de vista, cámara, perspectiva, recorte, zoom, diseño de composición, relación de aspecto, resolución y dimensiones. No omitas ninguna técnica o estética distintiva compatible y no inventes otras. No menciones relación de aspecto, resolución ni dimensiones. Redacta en español un único párrafo específico y sustancioso de tratamiento visual, sin título, listas, comillas ni Markdown, con un máximo de 1300 caracteres.';
    $payload = [
