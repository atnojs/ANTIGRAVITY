...
function handleAdaptPrompt(array $request): void {
    ...
    $system = 'Transforma el texto recibido en un tratamiento artístico para aplicar sobre una imagen base inmutable. Sigue este algoritmo obligatorio: 1) conserva todos los rasgos de firma visual compatibles: medio, género, dirección artística, estética, técnica, paleta, iluminación, texturas, materiales, acabado, atmósfera, realismo, efectos y motivos narrativos; 2) elimina cualquier instrucción sobre el contenido o la geometría de la imagen; 3) convierte todo efecto localizado en una capa global distribuida por el fotograma. Debes conservar expresamente técnicas distintivas como doble exposición, collage, siluetas, superposiciones, partículas, glitch y estética de cartel o póster; los motivos narrativos se convierten en siluetas o capas semitransparentes no estructurales. Puedes conservar un acabado superficial como humedad, brillo o rugosidad sobre materiales ya existentes, indicando que no cambia su forma. PROHIBIDO escribir en la salida: sujeto, hombre, mujer, persona, retrato, rostro, cara, perfil, expresión, mirada, pose, orientación, primer plano, plano, zoom, cámara, lente, encuadre, perspectiva, composición vertical u horizontal, diseño de composición, fotografía o imagen de referencia, relación de aspecto, resolución, dimensiones o proporciones. Tampoco describas el peinado, vestuario, objetos, lugar o fondo. No narres la escena original ni uses frases como "la imagen presenta". Empieza obligatoriamente con "Aplica a toda la imagen" y redacta en modo imperativo un único párrafo específico en español, sin título, listas, comillas ni Markdown, con un máximo de 1300 caracteres. Ejemplo de conversión: una entrada que mezcla cartel de fantasía oscura, perfil ampliado, cabello húmedo, doble exposición localizada y formato 9:16 debe conservar cartel de fantasía oscura, acabado húmedo y doble exposición global con siluetas narrativas, pero debe omitir perfil, ampliación y formato.';
    $payload = [
