(function () {
    ...
    function createDefaultState() {
        ...
        return { version: 1, models: ['ChatGPT', 'Gemini', 'FLUX', 'Qwen', 'Grok'].map(function (name, index) { return { id: 'model-' + name.toLowerCase(), name: name, image: SAMPLE_IMAGE, items: [{ id: 'sample-' + index, title: 'Varios', image: SAMPLE_IMAGE, prompt: prompt }] }; }) };
    }
