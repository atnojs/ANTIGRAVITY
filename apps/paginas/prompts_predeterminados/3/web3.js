    ...
    illusionGenerateBtn.onclick = async () => {
        ...
        try {
            ...
            let promptText = `
                ...
                The attached image is a COMPOSITE LAYOUT.
                - LEFT HALF (0-50% width): This is the CONTAINER SHAPE / SILHOUETTE.
                - RIGHT HALF (50-100% width): These are the MATERIAL/PATTERN images to fill the shape with.

                [INSTRUCTION]
                Generate a NEW, SINGLE masterpiece using the Double Exposure technique.
                1. EXTRACT the shape from the LEFT SIDE of the input.
                2. IGNORE the right side strictly for composition (do not reproduce the grid).
                3. USE the images on the RIGHT SIDE as the source texture/content to FILL the shape.
            ...
            illusionData.contentImages.forEach((img, idx) => {
                ...
                promptText += `- Content Image ${idx + 1} (on the right): ${img.weight}% opacity/presence (${priority}).\n`;
            });
