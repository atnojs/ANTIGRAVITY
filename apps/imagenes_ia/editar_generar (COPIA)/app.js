                    ...
                    <div className="flex flex-col lg:flex-row min-h-screen">
                        <aside className="lg:w-[440px] glass border-r border-white/5 lg:sticky lg:top-0 lg:h-screen overflow-y-auto p-10 space-y-10 custom-scrollbar flex flex-col z-20">
                            ...
                            <div className="space-y-4">
                                <label className="text-[11px] font-bold text-cyan-400 uppercase tracking-widest">Describe lo que quieres conseguir</label>
                                ...
                                <div className="model-provider-layout" role="group" aria-label="Seleccionar modelo" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '.75rem' }}>
                                    {[
                                        ...
                                        <div className="model-provider-column" key={group.provider} style={{ minWidth: 0 }}>
                                            ...
                                            <span className="model-quality-hint" style={{ display: 'block', textAlign: 'center', marginBottom: '.35rem', ...(group.provider !== 'OPENAI' ? { visibility: 'hidden' } : {}) }}>De Menor a Mayor Calidad</span>
