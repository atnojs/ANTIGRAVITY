...
// InicializaciÃ³n de Firebase con la nueva configuraciÃ³n
firebase.initializeApp(firebaseConfig);
const auth = firebase.auth();
const db = firebase.firestore();

// Forzar logout al cargar la pÃ¡gina para siempre pedir login
auth.signOut();
...
const LoginModal = ({ onLogin }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.message.includes('auth/') ? 'Credenciales invÃ¡lidas' : err.message);
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="glass-modal w-full max-w-md p-8 rounded-3xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm mt-2">
                        {isLogin ? 'Inicia sesiÃ³n para continuar' : 'RegÃ­strate para acceder'}
                    </p>
                </div>
        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 space-y-12 relative">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-gray-300 text-lg md:text-2xl font-light max-w-2xl mx-auto">
                    <span className="neon-text font-semibold">GeneraciÃ³n/EdiciÃ³n/Estilos Visuales de ImÃ¡genes</span>
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 w-full max-w-[95rem]">
                ...
                >
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">Genera imÃ¡genes desde texto.</p>
                </button>

                {/* BotÃ³n Editar ImÃ¡genes */}
                <button
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold">Ajustar ImÃ¡genes</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">Corrige brillo, saturaciÃ³n y mÃ¡s.</p>
                </button>

                {/* BotÃ³n Combinar ImÃ¡genes */}
                <button
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold">Combinar ImÃ¡genes</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">Fusiona varias imÃ¡genes con IA.</p>
                </button>

                {/* BotÃ³n Copiar Estilo (NUEVO - 5TO BOTÃ“N) */}
                <button
                ...
                {/* BotÃ³n Illusion Diffusion (NUEVO - 6TO BOTÃ“N) */}
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-[63rem]">
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold">Decorar HabitaciÃ³n</h2>
                    <p className="text-gray-400 text-sm leading-relaxed">RediseÃ±a interiores con IA.</p>
                </button>
                ...
                >
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">Colorea imÃ¡genes con IA.</p>
                </button>

                {/* BotÃ³n Dibujo LÃ­neas */}
                <button
                ...
                >
                    ...
                    <h2 className="text-2xl font-bold">Dibujo LÃ­neas</h2>
