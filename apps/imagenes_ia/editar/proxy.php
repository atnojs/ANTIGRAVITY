...
// Análisis de texto/visión (§6): xiaomi/mimo-v2.6-pro vía OpenRouter (alias legado: gemini-3.8-flash).
...
if (strtolower((string)($req['model'] ?? '')) === 'qwen-pro') { handleQwenImage($req); exit; }
