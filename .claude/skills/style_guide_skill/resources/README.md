...
## 🖼️ Estándares de Exportación

Para asegurar la máxima compatibilidad con todos los visores de imágenes de sistema (Windows, macOS, etc.), se ha establecido el siguiente estándar:

- **Formato**: Siempre exportar imágenes en **.jpg**.
- **Razón**: Algunos visores de imágenes (como el de Windows) pueden dar errores al abrir archivos generados por IA si la extensión no es .jpg (aunque el contenido sea similar).
