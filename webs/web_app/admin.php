...
// ========================================
$ADMIN_USER = 'a@a';  // ← TU USUARIO
$ADMIN_PASSWORD = '0';  // ← TU CONTRASEÑA
// ========================================
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* NUEVO ESTILO PARA EL PLAN VIP */
        .badge.vip { background: rgba(156, 39, 176, 0.2); color: #d500f9; border: 1px solid #d500f9; }
