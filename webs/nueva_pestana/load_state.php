...
// Lógica de auto-recuperación (Self-healing SEGURO)
// Solo restaura si el principal NO existe o está vacío/corrupto.
// NUNCA compara fechas: evita resucitar versiones viejas por mtime o 'ultima_actualizacion'.
...
if (file_exists($ruta_backup)) {
    if (!file_exists($ruta_archivo)) {
        ...
        json_decode($contenido_principal, true);
