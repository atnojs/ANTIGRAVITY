document.addEventListener('DOMContentLoaded', () => {
    ...
    function processIconHtml(iconInput) {
        if (!iconInput) return '<i class="fa-solid fa-circle-user"></i>';
    ...
    function createTileCardElement(app, sourceArray) {
        ...
        // Icono de fondo y principal
        const iconHtml = processIconHtml(app.iconHtml);

        card.innerHTML = `
            <div class="bg-icon">${iconHtml}</div>
